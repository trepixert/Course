...
/*
	...
	происходила автоматическая сортировка по ключу (за уточнением в лс) (это не значит, что после добавления
	нового элемента нужно вызывать каждый раз функцию sort())
*/
